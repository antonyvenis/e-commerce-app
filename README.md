...
.hero-glow1 { background: rgba(255, 69, 0, 0.2); width: 500px; height: 500px; top: -120px; left: -80px; }
.hero-glow2 { background: rgba(255, 184, 0, 0.1); width: 380px; height: 380px; bottom: -80px; right: 60px; }
.hero-glow3 { background: rgba(255, 69, 0, 0.07); width: 240px; height: 240px; top: 50%; right: 28%; transform: translateY(-50%); }
.hero-grid-lines {
...
.hero-left { flex: 1; max-width: 540px; text-align: left; }
.hero-eyebrow {
...
.hero-tagline span { color: rgba(255, 184, 0, 0.9); font-weight: 600; }
.hero-stats {
...
.hero-stat-label { font-size: 10px; color: rgba(255, 255, 255, 0.4); letter-spacing: 0.06em; text-transform: uppercase; }
.hero-stack-row {
...
.hero-main-card { width: 240px; }
.hero-food-emoji { font-size: 32px; margin-bottom: 12px; display: block; line-height: 1; }
.hero-food-name { font-size: 14px; font-weight: 600; color: #fff; margin-bottom: 3px; }
.hero-food-rest { font-size: 11px; color: rgba(255, 255, 255, 0.4); margin-bottom: 10px; }
.hero-rating-row { display: flex; align-items: center; gap: 5px; margin-bottom: 10px; }
.hero-stars { color: #FFB800; font-size: 12px; }
.hero-rating-num { font-size: 11px; color: rgba(255, 255, 255, 0.4); }
.hero-tags { display: flex; gap: 5px; flex-wrap: wrap; margin-bottom: 14px; }
.hero-tag {
...
.hero-price { font-size: 16px; font-weight: 700; color: #FFB800; }
.hero-add-btn {
  background: linear-gradient(135deg, #FF4500, #FF6B35);
...
.hero-row-cards { display: flex; gap: 12px; }
.hero-mini-card {
  background: rgba(255, 255, 255, 0.04);
  border: 1px solid rgba(255, 255, 255, 0.07);
  border-radius: 14px;
...
.hero-mini-emoji { font-size: 24px; margin-bottom: 8px; display: block; }
.hero-mini-name { font-size: 11px; font-weight: 600; color: rgba(255, 255, 255, 0.8); margin-bottom: 4px; }
.hero-mini-price { font-size: 12px; font-weight: 700; color: #FFB800; }
.hero-order-card {
...
.hero-order-icon { font-size: 20px; }
.hero-order-title { font-size: 10px; font-weight: 600; color: rgba(255, 255, 255, 0.8); }
.hero-order-sub { font-size: 9px; color: rgba(255, 255, 255, 0.4); }
.hero-progress-bar {
  height: 3px;
...
@media (max-width: 768px) {
  ...
  .hero-banner-container { padding: 40px 24px; }
}
</style>

<div class="hero-banner-container">
  <div class="hero-bg-glow hero-glow1"></div>
  <div class="hero-bg-glow hero-glow2"></div>
  <div class="hero-bg-glow hero-glow3"></div>
  ...
  <div class="hero-content">
    ...
    <div class="hero-left">
      ...
      <div class="hero-brand">⚡𝓛𝓮𝓰𝓮𝓷𝓭💫⚡</div>
      ...
      <div class="hero-stats">
        ...
        <div class="hero-stat">
          <span class="hero-stat-num">30 min</span>
          <span class="hero-stat-label">Avg delivery</span>
        </div>
      </div>
      <div class="hero-stack-row">
        <span class="hero-stack-tag hot">React</span>
        <span class="hero-stack-tag hot">Django</span>
        <span class="hero-stack-tag">JWT Auth</span>
        <span class="hero-stack-tag">PostgreSQL</span>
        <span class="hero-stack-tag">Tailwind CSS</span>
      </div>
      <div class="hero-cta-row">
        <a href="https://e-commerce-app-food.vercel.app/profile" class="hero-btn-primary">
          ▶ &nbsp;Live Demo
        </a>
        <a href="https://github.com/antonyvenis" class="hero-btn-secondary">
          ⌥ &nbsp;GitHub
        </a>
      </div>
    </div>
    ...
    <div class="hero-right">
      <div class="hero-card hero-main-card">
        <span class="hero-popular-badge">⭐ Popular</span>
        <span class="hero-food-emoji">🍗</span>
        <div class="hero-food-name">Crispy Fried Chicken</div>
        <div class="hero-food-rest">ChennaiKFC · 2.1 km away</div>
        <div class="hero-rating-row">
          <span class="hero-stars">★★★★★</span>
          <span class="hero-rating-num">4.8 (320)</span>
        </div>
        <div class="hero-tags">
          <span class="hero-tag">Spicy</span>
          <span class="hero-tag">Bestseller</span>
        </div>
        <div class="hero-card-footer">
          <span class="hero-price">₹249</span>
          <button class="hero-add-btn">+ Add</button>
        </div>
      </div>
      <div class="hero-row-cards">
        <div class="hero-mini-card">
          <span class="hero-mini-emoji">🍕</span>
          <div class="hero-mini-name">Pepperoni</div>
          <div class="hero-mini-price">₹349</div>
        </div>
        <div class="hero-order-card">
          <span class="hero-order-icon">🛵</span>
          <div class="hero-order-title">On the way!</div>
          <div class="hero-order-sub">ETA: 12 min</div>
